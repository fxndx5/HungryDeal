...
# Añadir el directorio backend al path para que funcionen los imports
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

# Cargar modelos para autogenerate
from app.core.database import Base  # noqa: E402
from app.models import User, Restaurant, PlatformPrice, SearchHistory  # noqa: E402, F401
