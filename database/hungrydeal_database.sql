...
---------------------------------------------
-- Si quereis levantar la base de datos en local se puede ejecutar con:

-- psql -U postgres -d nombre_db -f hungrydeal_database.sql
------------------------------------------------
...
-- DATOS DE MUESTRA — Restaurantes
--------------------------------------------------------------------------------------------------------------------------
INSERT INTO public.restaurants (id, name, address, city, latitude, longitude, platforms, created_at, updated_at) VALUES
('mcdonalds-gran-via-madrid',  'McDonalds Gran Via',     'Gran Via, 55',                    'Madrid', 40.420000, -3.702500, ARRAY['uber_eats','glovo','just_eat'], '2026-05-24 12:12:08+00', '2026-05-24 12:12:08+00'),
('mcdonalds-sol-madrid',       'McDonalds Sol',          'Puerta del Sol, 2',               'Madrid', 40.416900, -3.703500, ARRAY['uber_eats','glovo'],             '2026-05-24 12:12:08+00', '2026-05-24 12:12:08+00'),
...
('pizza-hut-retiro',           'Pizza Hut Retiro',       'Calle de Alcala, 70',             'Madrid', 40.419000, -3.689000, ARRAY['uber_eats','glovo','just_eat'], '2026-05-24 12:12:08+00', '2026-05-24 12:12:08+00'),
('dominos-lavapies',           'Dominos Lavapies',       'Calle de Embajadores, 25',        'Madrid', 40.409000, -3.703000, ARRAY['uber_eats','just_eat'],          '2026-05-24 12:12:08+00', '2026-05-24 12:12:08+00')
ON CONFLICT (id) DO NOTHING;



-- DATOS DE MUESTRA — Usuarios demo
-- Contraseñas hasheadas con bcrypt (12 rounds)
-- Contraseña de prueba para todos los usuarios demo: Demo2026!
----------------------------------------------------------------------------------------------------------
...
-- DATOS DE MUESTRA — Historial de búsquedas
----------------------------------------------------------
...
('5ee918ae-a359-4b4f-8a34-ccf723f87aae', '2984f8cd-a4ec-450a-89b5-2b3cbaa0025d', 'McDonalds Gran Via',    'mcdonalds-gran-via-madrid','glovo',     0.50, '2026-05-06 12:12:49+00'),
('e774f283-13e7-4406-8c9e-b832c0c72a7a', '2984f8cd-a4ec-450a-89b5-2b3cbaa0025d', 'Dominos Lavapies',      'dominos-lavapies',        'just_eat',  1.49, '2026-05-09 12:12:49+00'),
...
('7aabf6a4-c707-4490-a1d5-f1566bd127f9', '2984f8cd-a4ec-450a-89b5-2b3cbaa0025d', 'McDonalds Sol',         'mcdonalds-sol-madrid',    'just_eat',  0.48, '2026-05-21 12:12:49+00'),
('cee0d2a5-a3d1-46dd-a309-d9eb2492ee50', '2984f8cd-a4ec-450a-89b5-2b3cbaa0025d', 'McDonalds Gran Via',    'mcdonalds-gran-via-madrid','just_eat',  1.99, '2026-05-24 12:12:49+00')
ON CONFLICT (id) DO NOTHING;
